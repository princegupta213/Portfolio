...
import { dataSynthCaseStudy as cs } from "@/data/case-studies/data-synth";

export default function DataSynthCaseStudyPage() {
  return (
    <div className="min-h-screen bg-zinc-50">
      ...
      <article className="mx-auto max-w-3xl px-6 py-12">
        <p className="text-sm font-medium tracking-wide text-emerald-600 uppercase">
          Case study · Growth PM · Synthetic Data
        </p>
        ...
        <div className="mt-10 rounded-xl border border-zinc-200 bg-white p-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-sm font-medium text-zinc-700">
            <FlowBox label="Persona config" />
            <Arrow />
            <FlowBox label="Batch generate" highlight />
            <Arrow />
            <FlowBox label="Quality KPIs" highlight />
            <Arrow />
            <FlowBox label="Export CSV/JSON" />
          </div>
          <p className="mt-4 text-center text-xs text-zinc-500">
            50 items · persona compliance · duplicate rate · generation time
          </p>
        </div>
        ...
        <div className="mt-16 rounded-xl bg-emerald-600 p-8 text-center text-white">
          <h2 className="text-xl font-bold">Generate sandbox data</h2>
          <p className="mt-2 text-emerald-100">
            Adjust persona and sentiment mix to stress-test classifiers before launch.
          </p>
          <Link
            href={cs.links.liveDemo}
